...
window.addEventListener("scroll", function () {
    ...
    var scrollpercent;
    if (isMobile) {
        scrollpercent = document.body.scrollTop / (document.body.scrollHeight - document.documentElement.clientHeight);
    } else {
    ...
    svgs.forEach(function (svg, index) {
        ...
        switch (index) {
            ...
            case 7:
                if (scrollpercent > bottomOffset) {
                    draw = lengths[index] * (scrollpercent - bottomOffset);
                    svg.style.strokeDashoffset = lengths[index] - draw / 3.8;
                }
                case 8:
                    if (scrollpercent > bottomOffset) {
                        draw = lengths[index] * (scrollpercent - bottomOffset);
